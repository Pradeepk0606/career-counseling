...
class StudentModelTest(TestCase):
    ...
    def test_entry_code_label(self):
        ...
        self.assertEqual(field_label, "entry code")
    ...
    def test_email_max_length(self):
        ...
        self.assertEqual(max_length, 254)  # EmailField default max_length
...
class DisciplineModelTest(TestCase):
    ...
    def test_subject_field_label(self):
        ...
        self.assertEqual(field_label, "subject field")
    ...
    def test_subject_field_on_delete_protect(self):
        ...
        self.assertEqual(on_delete, models.PROTECT)

    def test_object_name_is_name(self):
        discipline = Discipline.objects.get(id=1)
        expected_object_name = f"{discipline.name}"
        self.assertEqual(expected_object_name, str(discipline))
...
class SubjectFieldModelTest(TestCase):
    ...
    def test_object_name_is_name(self):
        ...
        self.assertEqual(expected_object_name, str(subject_field))
...
class SessionTermModelTest(TestCase):
    ...
    def test_object_name_is_name(self):
        ...
        self.assertEqual(expected_object_name, str(session_term))
...
class GradeLevelModelTest(TestCase):
    ...
    def test_object_name_is_name(self):
        ...
        self.assertEqual(expected_object_name, str(grade_level))
...
class AssessmentScoreModelTest(TestCase):
    ...
    def test_unique_together(self):
        ...
        self.assertEqual(unique_together, [("student", "subject", "session_term", "grade_level")])

    def test_ordering(self):
        assessment_score = AssessmentScore.objects.get(id=1)
        ordering = assessment_score._meta.ordering
        self.assertEqual(ordering, ["grade_level", "session_term"])

    def test_calculate_total_score(self):
        assessment_score = AssessmentScore.objects.get(id=1)
        total_score = assessment_score.calculate_total_score()
        self.assertEqual(total_score, 85)
    ...
    def test_str_method(self):
        ...
        self.assertEqual(expected_str, str(assessment_score))
